...
1. Use `npm` to nstall dependencies:
...
3. The .json file will be generated in `./grammars/` at the root of the project. You will need to copy it in to VS Code manually.
    ...
    3. Copy `powershell.tmLanguage.json` from `./grammars/` within the project folder to where you just renamed the file under VS Code's path.
